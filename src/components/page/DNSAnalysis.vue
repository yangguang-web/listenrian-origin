<template>
    <el-card class="wrap">
        <div class="condition">
            ...
            <!-- <span><el-input v-model="input" placeholder="搜索条件"  suffix-icon="el-icon-search" style="width:300px"></el-input></span> -->
            <span>
              <el-date-picker
              v-model="timerange"
              type="datetimerange"
        ...
        <div class="row">
            <div class="left">
              <div class="capture-header">
                ...
                <div class="capture-action">
                    <span><el-input v-model="input1" suffix-icon="el-icon-search" style="width:150px"></el-input></span>
            ...
            <div class="right">
              <div class="capture-header">
                ...
                <div class="capture-action">
                    <span><el-input v-model="input2" suffix-icon="el-icon-search" style="width:150px"></el-input></span>
                    <span><el-button type="primary">Excel</el-button></span>
                </div>
              </div>
              <el-divider></el-divider>
        ...
        <div class="row2">
            <div class="left">
              <div class="capture-header">
                ...
                <div class="capture-action">
                    <span><el-input v-model="input3" suffix-icon="el-icon-search" style="width:150px"></el-input></span>
                    <span><el-button type="primary">Excel</el-button></span>
                </div>
              </div>
              <el-divider></el-divider>
  ...
  methods:{
    ...
    getList(){
      ...
      this.$axios.get('/qqqqqqqqqq',{
        params:{
          //5个key,5个value 根据后端接收要求进行发送 默认已使用input保存五个值
